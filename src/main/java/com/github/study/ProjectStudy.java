...
import com.github.designroleminer.ProjectVisitor;
...
public class ProjectStudy implements Study {
	...
	public void mineOpenMRSVersions() {
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Web/openmrs-core"))
				...
				.process(new ProjectVisitor(),
						new CSVFile("D:/Projetos/_Web/project-web-openmrs.csv"))
				.mine();
	}
	...
	private void mineVersions() {
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Android/k-9")).through(Commits.list(k9Android))
			.withThreads(5)
			.process(new ProjectVisitor(), new CSVFile("D:/Projetos/_Android/versions-project-k-9-metrics.csv")).mine();
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Eclipse/droolsjbpm-tools"))
			...
			.process(new ProjectVisitor(), new CSVFile("D:/Projetos/_Eclipse/versions-project-droolsjbpm-tools-metrics.csv"))
			.mine();
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Web/openmrs-core"))
			...
			.process(new ProjectVisitor(), new CSVFile("D:/Projetos/_Web/versions-project-openmrs-core-metrics.csv"))
			.mine();
