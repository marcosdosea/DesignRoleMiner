...
public class MethodVisitor implements CommitVisitor {
	...
	public void process(SCMRepository repo, Commit commit, PersistenceMechanism writer) {
		...
		try {
			...
			writer.write("Commit", "Package", "SuperClass/[interfaces]", "Class", "Method", "Complexity", "LOC", "NOP", "Efferent Coupling");
...
//						writer.write(commit.getHash(), metodo.getNomePackage(), "\"" + metodo.getNomeInterfaces() + "\"", 
//							metodo.getNomeType(), metodo.getNomeMethod(), 
//							metrics.getComplexity(), metrics.getLinesOfCode(), metrics.getNumberOfParameters(), metrics.getEfferentCoupling());
//					} else {
//						writer.write(commit.getHash(), metodo.getNomePackage(), "\"" + metodo.getNomeSuperclasse() + "\"", 
//								metodo.getNomeType(), metodo.getNomeMethod(), 
//								metrics.getComplexity(), metrics.getLinesOfCode(), metrics.getNumberOfParameters(), metrics.getEfferentCoupling());
//					}
//						
