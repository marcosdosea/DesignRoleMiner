...
public class ClassStudy implements Study {
	...
	private void mineVersions() {
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Android/k-9")).through(Commits.list(k9Android))
			.withThreads(5)
			.process(new ClassVisitorCK(androidConcerns), new CSVFile("D:/Projetos/_Android/versions-class-k-9-metrics.csv")).mine();
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Eclipse/droolsjbpm-tools"))
			...
			.process(new ClassVisitorCK(eclipseConcerns), new CSVFile("D:/Projetos/_Eclipse/versions-class-droolsjbpm-tools-metrics.csv"))
			.mine();
		...
		new RepositoryMining().in(GitRepository.singleProject("D:/Projetos/_Web/openmrs-core"))
			...
			.process(new ClassVisitorCK(webConcerns), new CSVFile("D:/Projetos/_Web/versions-class-openmrs-core-metrics.csv"))
			.mine();
	}
